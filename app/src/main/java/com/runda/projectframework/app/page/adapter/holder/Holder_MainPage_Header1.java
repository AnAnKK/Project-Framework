 ...
 * @Version:        1.0
 */
public class Holder_MainPage_Header1 {
    ...
    public Holder_MainPage_Header1(Context context, List<String> data,ViewGroup viewGroup) {
        this.data = data;
    ...
    public void initialize() {
        ...
        rootView = inflater.inflate(R.layout.layout_header1, viewGroup, false);
        setup();
    }
