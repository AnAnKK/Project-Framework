...
import com.runda.projectframework.app.others.interfaces.OnItemLongClickListener;
 ...
 */
public class Adapter_GridImage extends
        RecyclerView.Adapter<Adapter_GridImage.ViewHolder> {
    ...
    public Adapter_GridImage(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_picture_add,
                viewGroup, false);
