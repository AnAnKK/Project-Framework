package com.runda.projectframework.app.widget.behavior.behaviorprofile;
 ...
 */
public class ProfileViewBehavior extends PercentageViewBehavior<View> {
     ...
     */
    public ProfileViewBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private ProfileViewBehavior(@NonNull Builder builder) {
        super(builder);
    ...
    public static class Builder extends PercentageViewBehavior.Builder<Builder> {
        ...
        public ProfileViewBehavior build() {
            return new ProfileViewBehavior(this);
        }
    }
}
