...
import com.runda.projectframework.app.others.swipemenu.MSwipeMenuCrator;
import com.runda.projectframework.app.others.swipemenu.OnSwipeRecyclerItemMoveListener;
import com.runda.projectframework.app.others.swipemenu.onMItemMenuClickListener;
 ...
 * @Version:        1.0
 */
public class Activity_RecyclerSwipe extends BaseActivity<BaseViewModel> {
    ...
    public void initEvents() {
        toolbar.getTitleView().setText("侧滑删除+拖拽");
    ...
    private void setData(List<String> list) {
        ...
        swipeRecyclerView.setSwipeMenuCreator(new MSwipeMenuCrator(Activity_RecyclerSwipe.this));
        swipeRecyclerView.setOnItemMenuClickListener(new onMItemMenuClickListener(Activity_RecyclerSwipe.this, new OnSwipeMenuItemClick() {
            @Override
            public void onClick(int direction, int position, int menuPosition) {
                ToastUtils.showShort("direction == "+direction+"  "+"list第" + position + "; 右侧菜单第" + menuPosition);
            }
        }));
